...
## Project Structure
    ...
    ├── testapiautoconnect_105156  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_105156`
...
2. Clone this repo and `cd testapiautoconnect_105156`
